...
def parse_args(args):
    ...
    parser.add_argument('--class-specific-filter', help='Enables class specific filtering.', dest='class_specific_filter', action='store_true')
    parser.add_argument('--orientation-specific-filter', help='Enables orientation specific filtering.', dest='orientation_specific_filter', action='store_true')
...
def main(args=None):
    ...
    model = models.load_model(args.model_in, convert=True, backbone_name=args.backbone, nms=args.nms, class_specific_filter=args.class_specific_filter, orientation_specific_filter=args.orientation_specific_filter)
